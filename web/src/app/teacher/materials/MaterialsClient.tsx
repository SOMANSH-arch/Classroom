// web/src/app/teacher/materials/MaterialsClient.tsx
'use client';
...
export function MaterialsClient() {
    ...
    // 2. Load materials when course is selected
    useEffect(() => {
        ...
        <Container sx={{ py: 4 }} maxWidth="md">
            ...
            <Box component="form" className="form" sx={{ bgcolor: '#2d2d2d', p: 3, borderRadius: 2, mb: 4 }}>
                ...
                <Box sx={{ border: '1px dashed #666', borderRadius: 1, p: 2, textAlign: 'center', mb: 2 }}>
                    <Button
                        component="label" variant="outlined" startIcon={<CloudUploadIcon />} sx={{ color: '#ccc', borderColor: '#666' }}
                    >
